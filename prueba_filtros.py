...
for i in range(3):  # Para las 3 filas de secciones
    for j in range(3):  # Para las 3 columnas de secciones
        ...
        if j == 0:  # Columna izquierda
            if i == 0 or i == 2:  # Filas superior e inferior
                valor = 0.025
            else:  # Fila central
                valor = 0.1
        ...
        seccion_filtrada = seccion * valor
...
cv2.imwrite('imagen_filtrada_sin_cuadricula_valores2.jpg', imagen_filtrada_limpia)
...
for i in range(3):
    for j in range(3):
        ...
        texto = f'{valor:.3f}'  # Redondear el valor del filtro a 3 decimales
...
cv2.imwrite('imagen_filtrada_con_cuadricula_y_valores2.jpg', imagen_filtrada_con_cuadricula)
